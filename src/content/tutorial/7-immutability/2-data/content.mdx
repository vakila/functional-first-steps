...
Several libraries exist implementing immutable data structures in JavaScript (see links in the further reading section). [Immer](https://immerjs.github.io/immer/docs/introduction) is a popular choice, so let's take a look at how it works.
